...
export default function AuthLayout({
  ...
  return (
    <div className="flex min-h-screen w-full">
      ...
      <div className="w-full xl:w-1/2 mx-auto bg-website-white overflow-y-auto flex justify-center items-center z-20 flex-col ">
        <Image src="/logo.svg" alt="Elmasa Logo" width={72} height={60} />
